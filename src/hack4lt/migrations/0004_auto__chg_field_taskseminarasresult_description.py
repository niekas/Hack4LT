...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskSeminarasResult.description'
        db.alter_column(u'hack4lt_taskseminarasresult', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'TaskSeminarasResult.description'
        db.alter_column(u'hack4lt_taskseminarasresult', 'description', self.gf('django.db.models.fields.TextField')(default=None))
