...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Topic'
        db.create_table(u'hack4lt_topic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=900)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=900)),
        ))
        db.send_create_signal(u'hack4lt', ['Topic'])

        # Adding model 'TaskSeminarasResult'
        db.create_table(u'hack4lt_taskseminarasresult', (
            ...
            ('repository', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.CharField')(default='2014-03-31', max_length=20)),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=900)),
        ))
        db.send_create_signal(u'hack4lt', ['TaskSeminarasResult'])


    def backwards(self, orm):
        # Deleting model 'Topic'
        db.delete_table(u'hack4lt_topic')

        # Deleting model 'TaskSeminarasResult'
        db.delete_table(u'hack4lt_taskseminarasresult')
    ...
    models = {
        ...
        u'hack4lt.taskseminarasresult': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'default': "'2014-03-31'", 'max_length': '20'}),
            'description': ('django.db.models.fields.TextField', [], {}),
