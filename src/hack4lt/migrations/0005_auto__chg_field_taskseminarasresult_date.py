...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskSeminarasResult.date'
        db.alter_column(u'hack4lt_taskseminarasresult', 'date', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'TaskSeminarasResult.date'
        db.alter_column(u'hack4lt_taskseminarasresult', 'date', self.gf('django.db.models.fields.CharField')(max_length=20))
