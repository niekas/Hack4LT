...
urlpatterns += i18n_patterns('',
    ...
    url(r'^topics/$', task.TopicList.as_view(), name='topics'),
    url(r'^topic/new/$', task.TopicCreate.as_view(), name='new-topic'),
    ...
    url(r'^profile/(?P<username>[\w._\-]*)/$', account.admin_profile_view, name='profile-view'),
    ...
    url(r'^reset-password/(?P<uidb36>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
            account.reset_password_view, name='reset-password'),
)
