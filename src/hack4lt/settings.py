# Django settings for Hack4LT project.
...
STATICFILES_DIRS = (
    os.path.join(BUILDOUT_DIR, 'src', 'hack4lt', 'static'),
)
...
SECRET_KEY = 'z=o)$(oc@f3#@+-0rq54oz%a-3xc1b85l_^!l$x(u%!zw+(%u#'
...
EMAIL_HOST = 'Hack4.LT'
EMAIL_HOST_USER = 'info@Hack4.LT'
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'info@Hack4.LT'
